 ...
 * @LastEditTime: 2022-05-19 07:02:22
  ...
  <div class="container">
    ...
    <el-card>
      ...
      <el-row :gutter="10">
        ...
        <el-col :span="7">
          <span>发布账号</span>
          <el-input placeholder="请选择" v-model="query.nickname" clearable @clear="queryPage" size="small">
            <template #append>
        ...
        <el-col :span="7">
          <span>审核状态</span>
          <el-input placeholder="请选择" v-model="query.auditStatus" clearable @clear="queryPage" size="small">
            <template #append>
              <el-button icon="el-icon-search" @click="queryPage"></el-button>
            </template>
          </el-input>
      ...
      <el-row :gutter="10">
        <el-col :span="10">
          <span>发布内容</span>
          <el-input placeholder="请选择" v-model="query.content" clearable @clear="queryPage" size="small">
            <template #append>
        ...
        <el-col :span="7">
          <span>所属标签</span>
          <el-input placeholder="请选择" v-model="query.tag" clearable @clear="queryPage" size="small">
            <template #append>
              <el-button icon="el-icon-search" @click="queryPage"></el-button>
            </template>
          </el-input>
      ...
      <el-table :data="list" border stripe @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="nickname" label="发布人" width="100px" align="center">
          <template v-slot="scope">
            <div>{{ scope.row.nickname }}</div>
            <el-avatar :size="50" :src="scope.row.avatar" />
          </template>
        </el-table-column>
        <el-table-column prop="telephone" label="绑定手机号" align="center" width="200">
          <template v-slot="scope">
            <el-tag v-if="scope.row.telephone" type="primary">{{ scope.row.telephone }}</el-tag>
            <el-tag v-else type="danger">未绑定手机</el-tag>
          </template>
        </el-table-column>
