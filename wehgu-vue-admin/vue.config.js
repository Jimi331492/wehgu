 ...
 * @LastEditTime: 2022-04-17 13:48:54
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \wehgu-vue-admin\vue.config.js
 */
const externals = {
  vue: 'Vue',
...
const cdn = {
  css: ['https://unpkg.com/nprogress@0.2.0/nprogress.css', 'https://unpkg.com/element-plus@1.1.0-beta.20/theme-chalk/index.css'],
  ...
  js: [
    ...
    'https://unpkg.com/element-plus@1.1.0-beta.20/dist/index.full.js',
